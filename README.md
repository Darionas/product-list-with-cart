# Frontend Mentor challenge - Product list with cart solution
...
- [ ] Create CSS layout for mobile first (3rd task)
- [ ] Create CSS layout for tablet (4th task)
- [ ] Craete CSS layout for desktop (5th task)
